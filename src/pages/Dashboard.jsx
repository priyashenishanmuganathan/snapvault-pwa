...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 max-w-5xl mx-auto space-y-6 md:space-y-8 pb-24 text-zinc-100">
      ...
      {/* Top Banner Row */}
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-900/80 pb-5">
        <div>
        ...
        <button 
          ...
          className="w-full sm:w-auto justify-center rounded-xl bg-zinc-100 hover:bg-white text-zinc-950 px-4 py-2.5 sm:py-2 text-xs font-bold transition shadow-sm flex items-center gap-1.5 active:scale-95"
        >
          <span>✨</span> Ask AI
        </button>
      </header>
      ...
      <section className="border border-zinc-900 bg-zinc-900/20 rounded-2xl p-4 sm:p-6 md:p-8">
        <div className="mb-6">
        ...
        {/* Outer Adaptive Grid Wrapper Layout */}
        <div className="grid gap-6 lg:grid-cols-12 items-center">
          
          {/* Responsive Centered Pie Chart Display Box Frame */}
          <div className="lg:col-span-7 h-[280px] sm:h-[340px] md:h-[440px] w-full flex items-center justify-center relative bg-zinc-900/10 border border-zinc-900/60 rounded-xl overflow-hidden">
          ...
          {/* Categorized Legend List Module */}
      ...
      <section className="border border-zinc-900 bg-zinc-900/20 rounded-2xl p-4 sm:p-6">
        ...
        {recentReceipts.length === 0 ? (
          ...
          /* Scroll Container Shield for Small Viewports */
